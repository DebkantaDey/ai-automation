...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'b819f7...' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'NewSecret123!' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'Confirm new password is required' }),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'CurrentSecret123!' }),
    (0, class_validator_1.IsString)(),
