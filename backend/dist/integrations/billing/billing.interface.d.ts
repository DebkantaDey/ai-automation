...
export interface BillingWebhookEvent {
    ...
    eventType: 'checkout.session.completed' | 'subscription.created' | 'subscription.updated' | 'subscription.deleted' | 'subscription.authenticated' | 'subscription.charged' | 'subscription.pending' | 'subscription.cancelled' | 'invoice.paid' | 'invoice.payment_succeeded' | 'invoice.payment_failed' | 'payment_intent.succeeded' | 'payment_intent.payment_failed' | string;
    customerId?: string;
