export interface VerticalBlueprint {
  ...
  sampleServices: Array<{ description: string; unitPrice: number; category: string }>;
  aiAgent: {
    name: string;
    description: string;
    instructions: string;
  ...
  sampleLeads: Array<{ name: string; email: string; phone: string; company?: string; notes: string; score: number }>;
}

export const VERTICAL_BLUEPRINTS: VerticalBlueprint[] = [
  {
