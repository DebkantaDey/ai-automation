    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-4 border-neutral-200">
          ...
          <div className="mt-3">
            <span className="text-2xl font-bold font-mono text-neutral-900">$180,000</span>
        ...
        <Card className="p-4 border-neutral-200">
          ...
          <div className="mt-3">
            <span className="text-2xl font-bold font-mono text-neutral-900">$146,800</span>
        ...
        <Card className="p-4 border-neutral-200">
          ...
          <div className="mt-3">
            <span className="text-2xl font-bold font-mono text-neutral-900">48</span>
            <p className="text-[11px] text-neutral-600 font-semibold mt-1">87% AI Qualification Rate</p>
          </div>
        </Card>
        ...
        <Card className="p-4 border-neutral-200">
          ...
          <div className="mt-3">
            <span className="text-2xl font-bold font-mono text-neutral-900">34.2%</span>
            <p className="text-[11px] text-neutral-600 font-semibold mt-1">+4.8% vs last quarter</p>
          </div>
        </Card>
      </div>
      ...
      <Card className="border-neutral-200">
        <CardHeader className="py-3 px-5 border-b border-neutral-100 flex flex-row items-center justify-between">
          <div>
            <CardTitle className="text-sm font-bold text-neutral-900">Active Deals & Opportunities</CardTitle>
                ...
                {filteredDeals.map((deal) => (
                  <tr key={deal.id} className="hover:bg-neutral-50 transition-colors">
                    ...
                    <td className="py-3 px-5 font-mono">
                      <div className="flex items-center gap-2">
                        <span className="text-neutral-700">{deal.probability}%</span>
                        <div className="w-12 h-1.5 rounded-full bg-neutral-200 overflow-hidden">
                          <div className="h-full bg-neutral-900 rounded-full" style={{ width: `${deal.probability}%` }} />
                        </div>
                      </div>
                    </td>
