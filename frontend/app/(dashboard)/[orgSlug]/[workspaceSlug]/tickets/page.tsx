            ...
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-neutral-100">
                {filteredTickets.map((tick) => (
                  <tr key={tick.id} className="hover:bg-neutral-50">
                    <td className="py-3 px-5">
                      <div className="font-semibold text-neutral-900">{tick.subject}</div>
                      <p className="text-[10px] text-neutral-400 font-mono mt-0.5">{tick.id}</p>
                    </td>
                    <td className="py-3 px-5 text-neutral-600 font-medium">
                      {tick.customer}
                    </td>
                    ...
                    <td className="py-3 px-5 font-mono text-[11px] text-neutral-700">
                      {tick.assignedTo}
                    </td>
